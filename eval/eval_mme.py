...
parser.add_argument('--mme_bench_path', type=str, default='lmms-lab/MME', help='Path to the MME benchmark')
parser.add_argument('--save_path', type=str, default='./eval_results/mme', help='Path to save the results')
...
mme_bench_path = args.mme_bench_path
...
if __name__ == "__main__":
    ...
    dataset = load_dataset(args.mme_bench_path)
    test_types = ['test']
    ...
    for test_type in test_types:
        ...
        with tqdm(total=len(data_items), desc="Processing MME "+test_type) as pbar:
